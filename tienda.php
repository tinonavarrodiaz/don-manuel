  ...
  <body class="pageTienda">
    <header class="main-header" id="mainHeader">
      ...
      <nav class="main-nav" itemscope itemtype="http://schema.org/SiteNavigationElement" role="navigation" id="main-nav">
        ...
        <ul class="main-menu" id="main-menu">
          ...
          <li class="main-menu__item selected" itemprop="url"><a class="main-menu__link selected" href="tienda.php" itemprop="name">Tienda en línea</a></li>
    ...
    <main>
      ...
      <section class="section store">
        <div class="seleccion">
          <h2 class="section__title">Sección tienda en línea:</h2>
          <div class="store__gallery"><a class="product-item" href="producto.html">
              <div class="img-c-con"><img src="img/productos/producto1.png" alt="Don Manuel 1"></div>
              <p class="text-c">Don Manuel 1</p>
              <p class="price-c">1000</p></a><a class="product-item" href="producto.html">
