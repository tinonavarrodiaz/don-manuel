...
<html lang="es">
  <head>
    <title>Inicio - Puros Don Manuel</title>
    <meta charset="utf-8">
  ...
  <body class="pageInicio">
    ...
    <main>
      ...
      <section class="section banner">
        <p class="banner__text">Desde 1929 elaboramos todotipo de puros de sabores juveniles, finos y extrafinos, tabaco de masticar, tabaco de cigarro, shisha y tabaco de pipa</p>
        <div class="banner__circle-container">
          <div class="banner__circle"></div>
          <div class="banner__circle"></div>
        </div>
        <h2 class="banner__title">Elaboramos puros personalizados </br> con nombre y fecha</h2>
      </section>
      <section class="section p-t">
        <div class="seleccion">
          <h2 class="section__title">Nuestra selección de hoy</h2>
          <div class="carrucel-container"><img class="btn-prev" src="img/Siguiente.2.png"><img class="btn-next" src="img/Siguiente.png">
            <div class="owl-carousel uno">
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto1.png" alt="Don Manuel 1"></div>
                <p class="text-c">Don Manuel 1</p>
              </div>
              <div class="item-c star">
                <div class="img-c-con"><img src="img/productos/producto2.png" alt="Don Manuel 2"></div>
                <p class="text-c">Don Manuel 2</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto3.png" alt="Don Manuel 3"></div>
                <p class="text-c">Don Manuel 3</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto4.png" alt="Don Manuel 4"></div>
                <p class="text-c">Don Manuel 4</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto5.png" alt="Don Manuel 5"></div>
                <p class="text-c">Don Manuel 5</p>
              </div>
              <div class="item-c star">
                <div class="img-c-con"><img src="img/productos/producto6.png" alt="Don Manuel 6"></div>
                <p class="text-c">Don Manuel 6</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto7.png" alt="Don Manuel 7"></div>
                <p class="text-c">Don Manuel 7</p>
              </div>
              <div class="item-c star">
                <div class="img-c-con"><img src="img/productos/producto8.png" alt="Fui Padre 1"></div>
                <p class="text-c">Fui Padre 1</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto9.png" alt="Fui Padre 2"></div>
                <p class="text-c">Fui Padre 2</p>
              </div>
              <div class="item-c star">
                <div class="img-c-con"><img src="img/productos/producto10.png" alt="Fui Padre 3"></div>
                <p class="text-c">Fui Padre 3</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto11.png" alt="Patargas 1"></div>
                <p class="text-c">Patargas 1</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto12.png" alt="Patargas 2"></div>
                <p class="text-c">Patargas 2</p>
              </div>
              <div class="item-c star">
                <div class="img-c-con"><img src="img/productos/producto13.png" alt="Patargas 3"></div>
                <p class="text-c">Patargas 3</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto14.png" alt="Patargas 4"></div>
                <p class="text-c">Patargas 4</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto15.png" alt="Patargas 5"></div>
                <p class="text-c">Patargas 5</p>
              </div>
              <div class="item-c">
                <div class="img-c-con"><img src="img/productos/producto16.png" alt="Patargas 6"></div>
                <p class="text-c">Patargas 6</p>
              </div>
            </div>
            <!--#carroucelElement.carroucelElement
            each item, i in seleccion
              if i===1 || i===5 ||i===9 ||i===12 ||i===7
                figure.figure-product
                  .star
                  .img-cont
                    img(src=`img/productos/${item.url}` alt=item.name)
                  figcaption= item.name
              else
                figure.figure-product.star
                  .img-cont
                    img(src=`img/productos/${item.url}` alt=item.name)
                  figcaption= item.name
            -->
      ...
      <section class="section p-t">
        <div class="seleccion">
          <h2 class="section__title">Otras marcas</h2>
          <div class="carrucel-container"><img class="btn-prev1" src="img/Siguiente.2.png"><img class="btn-next1" src="img/Siguiente.png">
